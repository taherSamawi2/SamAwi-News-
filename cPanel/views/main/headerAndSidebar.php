...
<!-- Mirrored from ekan-admin-templates.multipurposethemes.com/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 May 2019 01:12:06 GMT -->
<head>
    <meta charset="utf-8">
...
<!--<body class="hold-transition skin-dark dark-sidebar light sidebar-mini">-->
<body class="hold-transition skin-dark dark-sidebar light sidebar-mini rtl" >
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            <!-- mini logo -->
            <div class="logo-mini">
                <span class="dark-logo">SamAwi News</span>
                        ...
                        <ul class="dropdown-menu animated bounceIn">
                            ...
                            <li class="header">
                                <div class="p-20 bg-light">
                                    <div class="flexbox">
                                        <div>
                                            <h4 class="mb-0 mt-0">الرسائل</h4>
                                        </div>
                                        <div>
                                            <a href="#" class="text-danger">مسح الكل</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
...
<!--                <div class="info">-->
<!--                    <a href="#" class="link" data-toggle="tooltip" title="" data-original-title="الاعدادات"><i class="ion ion-gear-b"></i></a>-->
<!--                    <a href="#" class="link" data-toggle="tooltip" title="" data-original-title="Email"><i class="ion ion-android-mail"></i></a>-->
<!--                    <a href="#" class="link" data-toggle="tooltip" title="" data-original-title="تسجيل الخروج"><i class="ion ion-power"></i></a>-->
<!--                </div>-->
            </div>
...
<!--                <li class="header nav-small-cap"></li>-->
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="categories_view.php"><i class="fa fa-eye"></i>عرض التصنيفات </a></li>
                        <li><a href="categories_view.php?do=add"><i class="fa fa-plus"></i>اضافة تصنيف جديد</a></li>
                        <li><a href="categories_view.php?do=DeletedCats"><i class="fa fa-trash"></i>التصنيفات المحذوفة</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="‏‏posts_view.php"><i class="ti-more"></i>عرض المقالات </a></li>
                        <li><a href="posts_view.php?do=add"><i class="fa fa-plus"></i>اضافة مقاله جديد</a></li>
                    </ul>
                </li>
